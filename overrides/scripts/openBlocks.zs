...
recipes.addShaped(<openblocks:auto_anvil>, [[<ore:blockMetal>, <ore:blockMetal>, <ore:blockMetal>], [<ore:ingotIron>, <minecraft:anvil>, <ore:ingotIron>], [<ore:blockMagicalWood>, <ore:circuitBasic>, <ore:blockMagicalWood>]]);
