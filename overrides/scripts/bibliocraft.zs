...
recipes.addShaped(<bibliocraft:printingpress>, [[<ore:platePeridot>, <bibliocraft:bibliochase>, <ore:platePeridot>], [<minecraft:stone_slab:4>, <minecraft:stone_slab:4>, <minecraft:stone_slab:4>], [<ore:blockMetal>, <ore:blockMetal>, <ore:blockMetal>]]);
