...
#val oreDictGreen = <ore:dyeGreen>;
#oreDictGreen.add(<techreborn:dust:36>);
#val oreDictRed = <ore:dyeRed>;
#oreDictRed.add(<techreborn:dust:43>);
...
oreCertusQuartz.remove(<appliedenergistics2:quartz_ore>, <appliedenergistics2:charged_quartz_ore>);
